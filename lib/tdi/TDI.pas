...
type
  ...
  private
    ...
    procedure PageControlDragOver(Sender, Source: TObject; X, Y: Integer; State:
      TDragState; var Accept: Boolean);
    procedure PageControlMouseDown(Sender: TObject; Button: TMouseButton; Shift:
  ...
  public
    ...
    procedure FecharTodasAsAbas(Todas: Boolean);
...
(*Nome do método alterado por Leandro Siqueira*)
procedure TTDI.FecharTodasAsAbas(Todas: Boolean);
var
  i: Integer;
begin
  ...
  case Todas of
    True:
      begin
        // Alterado por Leandro Siqueira
        // Impede que o FormInicioTDI seja fechado
        // Ele sempre é o primeiro a ser carregado - logo, posição 0
...
begin
  FecharTodasAsAbas(False);
end;

procedure TTDI.MenuFecharTodas(Sender: TObject);
begin
  FecharTodasAsAbas(True);
end;
...
procedure TTDI.VisualizarAbas(Visualizador: IVisualizador; NaoExibir: TFormClass);
var
  i: Integer;
  Form: TForm;
begin
...
procedure TTDI.PageControlMouseDown(Sender: TObject; Button: TMouseButton; Shift:
  TShiftState; X, Y: Integer);
begin
...
procedure TTDI.PageControlDragOver(Sender, Source: TObject; X, Y: Integer; State:
  TDragState; var Accept: Boolean);
begin
